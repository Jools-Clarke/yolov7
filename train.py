...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    optimizer = smart_optimizer(model, opt.optimizer, hyp)
...
def parse_opt(known=False):
    ...
    parser.add_argument('--hyp', type=str, default=ROOT / 'data/hyps/hyp.scratch.fishleg.yaml', help='hyperparameters path')
    ...
    parser.add_argument('--optimizer', type=str, choices=['SGD', 'Adam', 'AdamW', 'FishLeg'], default='SGD', help='optimizer') #--- flag add fishleg
